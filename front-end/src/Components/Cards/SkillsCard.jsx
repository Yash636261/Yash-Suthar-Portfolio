...
function SkillsCard({ heading, description, techAndTools }) {
  ...
  return (
    <div className="mx-auto my-5 w-72 max-sm:w-full py-5 px-10 border border-gray-200 rounded-lg shadow-md overflow-hidden  transition duration-300 hover:scale-105 hover:shadow-lg hover:shadow-gray-700 bg-gray-100">
